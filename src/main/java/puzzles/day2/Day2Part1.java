 ...
 * number that have an ID containing exactly two of any letter and then separately counting those
...
public class Day2Part1 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    int twice = 0;
    int three = 0;
    Map<Character, Integer> charCount = null;
    for ( String line : InputParser.getInputStrings("day-2-part-1.txt")){
